                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($transaction->status == 'pending')
                                            ...
                                            <a href="{{ route('transactions.checkout', ['transactionId' => $transaction->id]) }}"
                                        ...
                                        @elseif ($transaction->status == 'paid' || $transaction->status == 'approved')
                                            ...
                                            <a href="{{ route('transactions.generateInvoice', ['transactionId' => $transaction->id]) }}"
                                    ...
                                    <td>
                                        <form action="{{ route('transactions.destroy', $transaction->id) }}" method="POST"
                                            ...
                                            <button type="button" class="btn btn-outline-danger btn-sm"
                                                onclick="confirmDelete({{ $transaction->id }})">Hapus</button>
                                        </form>
                                    </td>
                                </tr>
                            @endforeach
